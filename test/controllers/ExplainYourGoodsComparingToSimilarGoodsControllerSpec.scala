...
class ExplainYourGoodsComparingToSimilarGoodsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val explainYourGoodsComparingToSimilarGoodsRoute =
    routes.ExplainYourGoodsComparingToSimilarGoodsController.onPageLoad(NormalMode).url
  ...
  "ExplainYourGoodsComparingToSimilarGoods Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId)
        .set(ExplainYourGoodsComparingToSimilarGoodsPage, "answer")
        .success
        .value
