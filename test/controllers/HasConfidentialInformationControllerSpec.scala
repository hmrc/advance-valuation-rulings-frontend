...
class HasConfidentialInformationControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val hasConfidentialInformationRoute = routes.HasConfidentialInformationController.onPageLoad(NormalMode).url
  ...
  "HasConfidentialInformation Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(HasConfidentialInformationPage, true).success.value
