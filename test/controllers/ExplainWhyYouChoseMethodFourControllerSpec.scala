...
class ExplainWhyYouChoseMethodFourControllerSpec extends SpecBase {
  ...
  lazy val saveDraftRoute: String =
    routes.ExplainWhyYouChoseMethodFourController
  ...
  "ExplainWhyYouChoseMethodFour Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, explainWhyYouChoseMethodFourRoute)
