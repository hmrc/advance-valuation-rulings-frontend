...
class IsThereASaleInvolvedControllerSpec extends SpecBase {
  ...
  "IsThereASaleInvolved Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, isThereASaleInvolvedRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, isThereASaleInvolvedRoute)
