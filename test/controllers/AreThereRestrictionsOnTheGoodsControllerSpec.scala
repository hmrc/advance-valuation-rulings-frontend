...
class AreThereRestrictionsOnTheGoodsControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val areThereRestrictionsOnTheGoodsRoute = routes.AreThereRestrictionsOnTheGoodsController.onPageLoad(NormalMode).url
  ...
  "AreThereRestrictionsOnTheGoods Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(AreThereRestrictionsOnTheGoodsPage, true).success.value
