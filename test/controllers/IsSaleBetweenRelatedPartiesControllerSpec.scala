...
class IsSaleBetweenRelatedPartiesControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val isSaleBetweenRelatedPartiesRoute =
    routes.IsSaleBetweenRelatedPartiesController.onPageLoad(NormalMode, draftId).url
  ...
  "IsSaleBetweenRelatedParties Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        val request = FakeRequest(GET, isSaleBetweenRelatedPartiesRoute)
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        val request =
          FakeRequest(POST, isSaleBetweenRelatedPartiesRoute)
