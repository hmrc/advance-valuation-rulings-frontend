...
class AgentCompanyDetailsViewSpec extends ViewBehaviours {

  private val form: AgentCompanyDetailsFormProvider = app.injector.instanceOf[AgentCompanyDetailsFormProvider]

  private val view: AgentCompanyDetailsView = app.injector.instanceOf[AgentCompanyDetailsView]
  ...
  "AgentCompanyDetailsView" - {
    normalPage("agentCompanyDetails")()
  }
}
