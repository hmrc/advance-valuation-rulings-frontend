...
class AgentCompanyDetailsViewSpec extends ViewBehaviours {
  ...
  val messageKeyPrefix = "agentCompanyDetails"

  val form: AgentCompanyDetailsFormProvider = app.injector.instanceOf[AgentCompanyDetailsFormProvider]

  val view: AgentCompanyDetailsView = app.injector.instanceOf[AgentCompanyDetailsView]
