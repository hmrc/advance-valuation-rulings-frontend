...
class DescribeTheLegalChallengesViewSpec extends ViewBehaviours {
  ...
  val messageKeyPrefix = "describeTheLegalChallenges"

  val form: DescribeTheLegalChallengesFormProvider = app.injector.instanceOf[DescribeTheLegalChallengesFormProvider]

  val view: DescribeTheLegalChallengesView = app.injector.instanceOf[DescribeTheLegalChallengesView]
