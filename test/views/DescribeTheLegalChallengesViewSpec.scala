...
class DescribeTheLegalChallengesViewSpec extends ViewBehaviours {

  private val form: DescribeTheLegalChallengesFormProvider =
    app.injector.instanceOf[DescribeTheLegalChallengesFormProvider]

  private val view: DescribeTheLegalChallengesView = app.injector.instanceOf[DescribeTheLegalChallengesView]
  ...
  "DescribeTheLegalChallengesView" - {
    normalPage("describeTheLegalChallenges")()
  }
}
