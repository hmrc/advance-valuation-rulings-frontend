...
class IsThereASaleInvolvedViewSpec extends ViewBehaviours {
  ...
  val messageKeyPrefix = "isThereASaleInvolved"

  val form: IsThereASaleInvolvedFormProvider = app.injector.instanceOf[IsThereASaleInvolvedFormProvider]

  val view: IsThereASaleInvolvedView = app.injector.instanceOf[IsThereASaleInvolvedView]
