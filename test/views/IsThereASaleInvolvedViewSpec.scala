...
class IsThereASaleInvolvedViewSpec extends ViewBehaviours {

  private val form: IsThereASaleInvolvedFormProvider = app.injector.instanceOf[IsThereASaleInvolvedFormProvider]

  private val view: IsThereASaleInvolvedView = app.injector.instanceOf[IsThereASaleInvolvedView]
  ...
  "IsThereASaleInvolvedView" - {
    normalPage("isThereASaleInvolved")()
  }
}
