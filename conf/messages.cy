...
requiredInformation.inset.para = You need to be able to accept the following preconditions to continue. If you do not, it could delay your application for an Advance Valuation Ruling decision.[NEEDS WELSH]
...
uploadSupportingDocuments.error.rejected = Mae’n rhaid i’r ffeil dan sylw fod ar ffurf PDF neu jpeg
