...
checkYourAnswers.eori.name.label = Enw’r busnes cofrestredig
...
viewApplication.employee = About the applicant
viewApplication.organisation = About the organisation
viewApplication.agent = About the agent
viewApplication.trader = About the trader
