...
applicationContactDetails.telephoneNumber.error.length = Telephone number must not be more than 24 characters
...
businessContactDetails.telephoneNumber.error.length = Telephone number must not be more than 24 characters
businessContactDetails.checkYourAnswersLabel = businessContactDetails
...
importingGoods.point.3.link = Canllaw cam wrth gam (yn agor tab newydd)
importingGoods.point.4 = {0} ynghylch mewnforio, allforio a thollau i fusnesau
importingGoods.point.4.link = Gwybodaeth gyffredinol (yn agor tab newydd)
