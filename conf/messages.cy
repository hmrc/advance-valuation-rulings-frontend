service.name = Gwneud cais am Ddyfarniad Prisio Ymlaen Llaw
...
countrySelect.label = dewiswch wlad

caption.prefix = Yr adran hon yw
...
requiredInformation.change.hidden = Mae’n rhaid i chi allu derbyn y rhagamodau canlynol i fynd yn eich blaen. Os na fyddwch yn gwneud hynny, gallai oedi eich cais am benderfyniad ar Ddyfarniad Prisio Ymlaen Llaw.
...
checkRegisteredDetails.title.agentTrader = Gwirio manylion EORI y masnachwr
...
checkRegisteredDetails.error.required.organisation = Dewiswch ‘Iawn’ i gadarnhau manylion EORI y sefydliad
checkRegisteredDetails.error.required.agent = Dewiswch ‘Iawn’ i gadarnhau’ch manylion EORI
checkRegisteredDetails.error.required.employee.consent = Dewiswch ‘Iawn’ os yw’r manylion ar gyfer y cyfeiriad a’r enw yn gywir
...
checkRegisteredDetails.radio.agentOnBehalfOfTrader.yes = Iawn, dyma fanylion y masnachwr rwyf yn gwneud cais ar ei ran
checkRegisteredDetails.radio.agentOnBehalfOfTrader.no = Na, mae’r manylion hyn yn anghywir
...
eoriBeUpToDate.title.org = Mae’n rhaid bod manylion EORI y sefydliad yn gywir er mwyn defnyddio’r gwasanaeth hwn
eoriBeUpToDate.heading = Mae’n rhaid bod manylion eich rhif EORI yn gywir i ddefnyddio’r gwasanaeth hwn
eoriBeUpToDate.heading.org = Mae’n rhaid bod manylion EORI y sefydliad yn gywir er mwyn defnyddio’r gwasanaeth hwn
eoriBeUpToDate.paragraph.1 = Bydd angen i chi roi gwybod am newid mewn amgylchiadau er mwyn diweddaru’r manylion sydd gennym ar gofnod.
eoriBeUpToDate.paragraph.2 = Ar gyfer rhif EORI sy’n dechrau gyda GB, gallwch wneud y naill neu’r llall o’r canlynol:
eoriBeUpToDate.paragraph.1.org = I ddiweddaru’r enw neu’r cyfeiriad sydd gennym ar gofnod, bydd angen i’r sefydliad roi gwybod am newid mewn amgylchiadau.
eoriBeUpToDate.paragraph.2.org = Ar gyfer rhif EORI sy’n dechrau gyda GB, gall y sefydliad wneud y naill neu’r llall o’r canlynol:
eoriBeUpToDate.bulletPoint.1.link = llenwi ffurflen ymholiadau (yn agor tab newydd)
eoriBeUpToDate.bulletPoint.1 = {0}
eoriBeUpToDate.bulletPoint.2.link = Cysylltwch â Gwasanaeth Cwsmeriaid Cymraeg CThEF (yn agor tab newydd)
eoriBeUpToDate.bulletPoint.2 = {0}
eoriBeUpToDate.paragraph.1.agentOnBehalfOfTrader.public = Mae’n rhaid i chi gysylltu â’r masnachwr a gofyn iddo ddiweddaru manylion ei enw a’i gyfeiriad. Bydd angen iddo roi gwybod i CThEF am newid mewn amgylchiadau. Ni allwch wneud hyn ar ei ran.
eoriBeUpToDate.agentOnBehalfOfTrader.youcan.public = Gallwch wneud y canlynol:
eoriBeUpToDate.agentOnBehalfOfTrader.bulletPoint.1.link.public = rhoi cynnig arall arni
eoriBeUpToDate.agentOnBehalfOfTrader.bulletPoint.1.public = gwirio’r EORI a {0}
eoriBeUpToDate.agentOnBehalfOfTrader.bulletPoint.2.link.public = canslo’r cais
eoriBeUpToDate.agentOnBehalfOfTrader.bulletPoint.2.public = {0} a dechrau eto pan fydd gennych ei wybodaeth ddiweddaraf
eoriBeUpToDate.paragraph.1.agentOnBehalfOfTrader.private = Ni allwch fynd yn eich blaen â’r cais hwn. Mae hyn oherwydd eich bod wedi rhoi gwybod i ni nad ydych am fynd yn eich blaen oherwydd manylion EORI preifat y masnachwr.
eoriBeUpToDate.paragraph.2.agentOnBehalfOfTrader.private = Os oes angen rhagor o wybodaeth arnoch am fanylion EORI y masnachwr, bydd angen i chi cysylltu ag ef yn uniongyrchol.
...
eoriBeUpToDate.title.agentOnBehalfOfTrader.public = Mae’n rhaid i fanylion y masnachwr fod yn gywir er mwyn defnyddio’r gwasanaeth hwn
eoriBeUpToDate.heading.agentOnBehalfOfTrader.public = Mae’n rhaid i fanylion y masnachwr fod yn gywir er mwyn defnyddio’r gwasanaeth hwn
...
applicationContactDetails.jobTitle.label = Teitl eich swydd
applicationContactDetails.fullName.error.required = Nodwch eich enw llawn
applicationContactDetails.simpleChars.error.format = Mae’n rhaid i hyn gynnwys llythrennau, bylchau a chysylltnodau yn unig
applicationContactDetails.email.error.required = Nodwch eich cyfeiriad e-bost
...
valuationMethod.method2 = Dull 2 (gwerth trafodyn y nwyddau unfath)
...
valuationMethod.method3 = Dull 3 (gwerth trafodyn y nwyddau tebyg)
...
valuationMethod.method4 = Dull 4 (dull diddwytho)
...
isThereASaleInvolved.heading = Oes gwerthiant ar waith?
...
explainHowPartiesAreRelated.title = Disgrifiad o’r cysylltiad rhwng y partïon
explainHowPartiesAreRelated.heading = Disgrifiad o’r cysylltiad rhwng y partïon
explainHowPartiesAreRelated.label = Disgrifiad o’r cysylltiad rhwng y partïon
...
explainHowPartiesAreRelated.checkYourAnswersLabel =Disgrifiad o’r cysylltiad rhwng y partïon
explainHowPartiesAreRelated.error.length = Caniateir uchafswm o 8168 o gymeriadau
explainHowPartiesAreRelated.change.hidden = eich disgrifiad o’r cysylltiad rhwng y partïon
explainHowPartiesAreRelated.question = A allwch ddisgrifio sut mae’r ddau barti’n gysylltiedig?

areThereRestrictionsOnTheGoods.caption = Ynglŷn â’r nwyddau
areThereRestrictionsOnTheGoods.title = Cyfyngiadau o ran ailwerthu neu ddefnyddio’r nwyddau
areThereRestrictionsOnTheGoods.heading = Cyfyngiadau o ran ailwerthu neu ddefnyddio’r nwyddau
...
isTheSaleSubjectToConditions.heading = Amodau neu amgylchiadau a allai eich atal rhag prisio’r nwyddau
...
describeTheConditions.error.length = Caniateir uchafswm o 8168 o gymeriadau
...
describeTheConditions.change.hidden = eich disgrifiad o’r amodau neu’r amgylchiadau na allant gael eu cyfrifo

whyIdenticalGoods.caption = Ynglŷn â’r nwyddau
whyIdenticalGoods.title = Esboniwch pam nad ydych wedi defnyddio Dull 1
whyIdenticalGoods.heading = Esboniwch pam nad ydych wedi defnyddio Dull 1
whyIdenticalGoods.label = A allwch esbonio pam na allwch ddefnyddio Dull 1 i gyfrifo gwerth tollau eich nwyddau?
whyIdenticalGoods.paragraph.1 = Cyn i chi roi cynnig ar Ddull 2, mae’n rhaid i chi fod wedi defnyddio Dull 1 (gwerth trafodiad y nwyddau a fewnforiwyd).
...
haveYouUsedMethodOneInPast.heading = Rhowch dystiolaeth o ddatganiad Dull 1
haveYouUsedMethodOneInPast.paragraph.1 = Mae Dull 2 yn seiliedig ar werth trafodyn nwyddau unfath sy’n cael eu hallforio i’r DU cyn pen 90 diwrnod i’r nwyddau rydych yn eu prisio. Mae’n rhaid bod Tollau’r DU eisoes wedi derbyn hyn.
haveYouUsedMethodOneInPast.paragraph.2 = Gall tystiolaeth dderbyniol o ddatganiad Dull 1 gynnwys y canlynol:
haveYouUsedMethodOneInPast.bulletPoint.1 = copi o’r cofnod mewnforio ar gyfer y nwyddau unfath
haveYouUsedMethodOneInPast.bulletPoint.2 = copïau o’r dogfennau ategol
haveYouUsedMethodOneInPast.bulletPoint.3 = data a fydd yn helpu CThEF i olrhain mewnforio’r nwyddau unfath
haveYouUsedMethodOneInPast.paragraph.inset = Os na allwch roi tystiolaeth o ddatganiad Dull 1, bydd angen i chi ddewis dull prisio arall ar gyfer eich nwyddau.
...
haveYouUsedMethodOneInPast.change.hidden = eich ymateb i a allwch roi tystiolaeth o ddatganiad Dull 1
haveYouUsedMethodOneInPast.question = A oes gennych dystiolaeth o ddatganiad Dull 1?
...
describeTheIdenticalGoods.error.length = Caniateir uchafswm o 8168 o gymeriadau
describeTheIdenticalGoods.change.hidden = eich disgrifiad o’r nwyddau unfath

whyTransactionValueOfSimilarGoods.caption = Ynglŷn â’r nwyddau
whyTransactionValueOfSimilarGoods.title = Esboniwch pam nad ydych wedi defnyddio Dull 1 na 2
whyTransactionValueOfSimilarGoods.heading = Esboniwch pam nad ydych wedi defnyddio Dull 1 na 2
whyTransactionValueOfSimilarGoods.label = A allwch esbonio pam na allwch ddefnyddio Dull 1 na 2 i gyfrifo gwerth tollau eich nwyddau?
...
whyTransactionValueOfSimilarGoods.error.required = Nodwch reswm pam na all Dull 1 na 2 gael eu defnyddio
...
whyTransactionValueOfSimilarGoods.change.hidden = eich rheswm dros beidio â dewis Dulliau 1-2 i brisio’r nwyddau

haveYouUsedMethodOneForSimilarGoodsInPast.caption = Ynglŷn â’r nwyddau
haveYouUsedMethodOneForSimilarGoodsInPast.title = Rhowch dystiolaeth o ddatganiad Dull 1
haveYouUsedMethodOneForSimilarGoodsInPast.heading = Rhowch dystiolaeth o ddatganiad Dull 1
...
haveYouUsedMethodOneForSimilarGoodsInPast.paragraph.3 = Gall tystiolaeth dderbyniol o ddatganiad Dull 1 gynnwys y canlynol:
haveYouUsedMethodOneForSimilarGoodsInPast.bulletPoint.1 = Dull 1 (gwerth trafodiad y nwyddau a fewnforiwyd)
haveYouUsedMethodOneForSimilarGoodsInPast.bulletPoint.2 = Dull 2 (gwerth trafodiad nwyddau unfath)
haveYouUsedMethodOneForSimilarGoodsInPast.bulletPoint.3 = copi o’r cofnod mewnforio ar gyfer y nwyddau unfath
haveYouUsedMethodOneForSimilarGoodsInPast.bulletPoint.4 = copïau o’r dogfennau ategol
haveYouUsedMethodOneForSimilarGoodsInPast.bulletPoint.5 = data a fydd yn helpu CThEF i olrhain mewnforio’r nwyddau unfath
haveYouUsedMethodOneForSimilarGoodsInPast.paragraph.inset = Os na allwch roi tystiolaeth o ddatganiad Dull 1, bydd angen i chi ddewis dull prisio arall ar gyfer eich nwyddau.
...
haveYouUsedMethodOneForSimilarGoodsInPast.change.hidden = eich ymateb i a allwch roi tystiolaeth o ddatganiad Dull 1, sydd wedi’i dderbyn gan Dollau’r DU cyn pen 90 diwrnod ar ôl mewnforio nwyddau sy’n debyg i’r rhai sy’n cael eu prisio
...
describeTheSimilarGoods.checkYourAnswersLabel = Disgrifiad o nwyddau tebyg
describeTheSimilarGoods.error.required = Nodwch ddisgrifiad o’r nwyddau tebyg
describeTheSimilarGoods.error.length = Caniateir uchafswm o 8168 o gymeriadau
describeTheSimilarGoods.change.hidden = eich disgrifiad o’r nwyddau tebyg

explainWhyYouHaveNotSelectedMethodOneToThree.caption = Ynglŷn â’r nwyddau
explainWhyYouHaveNotSelectedMethodOneToThree.title = Esboniwch pam nad ydych wedi defnyddio Dull 1 i 3
explainWhyYouHaveNotSelectedMethodOneToThree.heading = Esboniwch pam nad ydych wedi defnyddio Dull 1 i 3
explainWhyYouHaveNotSelectedMethodOneToThree.label = A allwch esbonio pam na allwch ddefnyddio Dull 1 i 3 i gyfrifo gwerth tollau eich nwyddau?
...
explainWhyYouChoseMethodFour.error.length = Caniateir uchafswm o 8168 o gymeriadau
explainWhyYouChoseMethodFour.change.hidden = eich rheswm dros ddewis Dull 4 i brisio’r nwyddau

whyComputedValue.caption = Ynglŷn â’r nwyddau
whyComputedValue.title = Esboniwch pam nad ydych wedi defnyddio Dull 1 i 4
whyComputedValue.heading = Esboniwch pam nad ydych wedi defnyddio Dull 1 i 4
whyComputedValue.label = A allwch esbonio pam na allwch ddefnyddio Dull 1 i 4 i gyfrifo gwerth tollau eich nwyddau?
...
explainReasonComputedValue.error.length = Caniateir uchafswm o 8168 o gymeriadau
explainReasonComputedValue.change.hidden = eich rheswm dros ddewis Dull 5 i brisio’r nwyddau

explainWhyYouHaveNotSelectedMethodOneToFive.caption = Ynglŷn â’r nwyddau
explainWhyYouHaveNotSelectedMethodOneToFive.title = Esboniwch pam nad ydych wedi defnyddio Dull 1 i 5
explainWhyYouHaveNotSelectedMethodOneToFive.heading = Esboniwch pam nad ydych wedi defnyddio Dull 1 i 5
explainWhyYouHaveNotSelectedMethodOneToFive.label = A allwch esbonio pam na allwch ddefnyddio Dull 1 i 5 i gyfrifo gwerth tollau eich mewnforion?
...
explainWhyYouHaveNotSelectedMethodOneToFive.error.required = Nodwch reswm pam na all Dull 1, 2, 3, 4, na 5 gael eu defnyddio
...
explainWhyYouHaveNotSelectedMethodOneToFive.change.hidden = eich rheswm dros beidio â dewis Dulliau 1-5 i brisio’r nwyddau
...
adaptMethod.change.hidden = y dull yr hoffech ei addasu

explainHowYouWillUseMethodSix.caption = Ynglŷn â’r nwyddau
explainHowYouWillUseMethodSix.title = Esboniwch sut y gwnaethoch ddefnyddio Dull 6
explainHowYouWillUseMethodSix.heading = Esboniwch sut y gwnaethoch ddefnyddio Dull 6
explainHowYouWillUseMethodSix.label = A allwch esbonio sut y gwnaethoch ddefnyddio Dull 6 i brisio’ch nwyddau?
explainHowYouWillUseMethodSix.checkYourAnswersLabel = Esboniad o sut rydych wedi defnyddio Dull 6 i brisio’ch nwyddau
explainHowYouWillUseMethodSix.error.required = Nodwch fanylion ynghylch sut y gwnaethoch ddefnyddio Dull 6, a pha Ddull yr hoffech gael hyblygrwydd arno
...
explainHowYouWillUseMethodSix.change.hidden = eich esboniad o sut rydych chi wedi defnyddio Dull 6 i brisio’r nwyddau
...
describeTheLegalChallenges.error.length = Caniateir uchafswm o 8168 o gymeriadau
...
confidentialInformation.error.length = Caniateir uchafswm o 8168 o gymeriadau
confidentialInformation.change.hidden = disgrifio gwybodaeth gyfrinachol
...
doYouWantToUploadDocuments.title = Dogfennau ategol
doYouWantToUploadDocuments.heading = Dogfennau ategol
...
uploadLetterOfAuthority.caption = Ynglŷn â’r ymgeisydd
...
uploadLetterOfAuthority.paragraph.3 = Peidiwch ag uwchlwytho ffeiliau sydd wedi’u diogelu gan gyfrinair, gan y bydd hyn yn atal prosesu’ch cais.
...
uploadLetterOfAuthority.button = Uwchlwytho ac yn eich blaen
...
uploadSupportingDocuments.paragraph.2 = Mae’n rhaid i ffeil unigol fod yn:
...
uploadSupportingDocuments.bulletPoint.4 = PDF neu’n JPG
...
fileUpload.error.invalidcharacters = You cannot upload files with special characters
...
uploadAnotherSupportingDocument.agentForTrader.title.one = Rydych wedi uwchlwytho 1 ddogfen ategol ac 1 llythyr o awdurdod
uploadAnotherSupportingDocument.agentForTrader.heading.one = Rydych wedi uwchlwytho 1 ddogfen ategol ac 1 llythyr o awdurdod
...
uploadAnotherSupportingDocument.error.fileCount = Gallwch uwchlwytho hyd at {0} ffeil yn unig
uploadAnotherSupportingDocument.change.hidden = uwchlwytho dogfen arall
uploadAnotherSupportingDocument.one = un
uploadAnotherSupportingDocument.keepConfidential = Cadw’n gyfrinachol
uploadAnotherSupportingDocument.remove.hidden = Tynnu {0} oddi ar eich rhestr o ddogfennau ategol
uploadAnotherSupportingDocument.letterOfAuthority = Llythyr o awdurdod
uploadAnotherSupportingDocument.uploadedDocuments = Dogfennau wedi’u Huwchlwytho
uploadAnotherSupportingDocument.title.max = Uchafswm nifer y dogfennau ategol wedi’u huwchlwytho
uploadAnotherSupportingDocument.heading.max = Uchafswm nifer y dogfennau ategol wedi’u huwchlwytho
uploadAnotherSupportingDocument.agentForTrader.maxInfo = Ar hyn o bryd, gallwch uwchlwytho hyd at 4 ffeil fel tystiolaeth ac 1 llythyr o awdurdod. Os oes gennych unrhyw ddogfennau ychwanegol, rhowch wybod i’ch gweithiwr achos unwaith y bydd un yn cael ei neilltuo i’ch achos.
uploadAnotherSupportingDocument.maxInfo = Ar hyn o bryd, gallwch uwchlwytho hyd at 5 ffeil fel tystiolaeth. Os oes gennych unrhyw ddogfennau ychwanegol, rhowch wybod i’ch gweithiwr achos unwaith y bydd un yn cael ei neilltuo i’ch achos.
uploadAnotherSupportingDocument.agentForTrader.title.many = Rydych wedi uwchlwytho {0} o ddogfennau ategol ac 1 llythyr o awdurdod
uploadAnotherSupportingDocument.agentForTrader.heading.many = Rydych wedi uwchlwytho {0} o ddogfennau ategol ac 1 llythyr o awdurdod
uploadAnotherSupportingDocument.remaining = Gallwch uwchlwytho {0} o ddogfennau eraill.
uploadAnotherSupportingDocument.remaining.one = Gallwch uwchlwytho 1 dogfen arall.



isThisFileConfidential.title = Rhowch wybod i ni a hoffech wneud y ddogfen hon yn gyfrinachol
isThisFileConfidential.heading = Rhowch wybod i ni a hoffech wneud y ddogfen hon yn gyfrinachol
isThisFileConfidential.question = A ydych am nodi’r ddogfen hon yn gyfrinachol?

isThisFileConfidential.uploadedFile = Dogfen wedi’i huwchlwytho
...
checkYourAnswers.eori.number.label = Rhif EORI cofrestredig y sefydliad
checkYourAnswers.eori.name.label = Enw busnes cofrestredig y sefydliad
checkYourAnswers.eori.address.label = Cyfeiriad busnes cofrestredig y sefydliad
...
checkYourAnswers.applicant.jobTitle.label = Teitl swydd yr ymgeisydd
checkYourAnswer.applicant.dateSubmitted.label = Dyddiad cyflwyno
...
checkYourAnswers.declaration.bulletPoint.4 = rydych yn ymwybodol bod cael penderfyniad ar Ddyfarniad Prisio Ymlaen Llaw yn gallu cymryd hyd at 120 diwrnod o’r dyddiad y derbynnir eich cais
...
checkYourAnswers.declaration.2 = gwybodaeth am batentau
...
checkYourAnswersForAgents.agent.eori.number.label =  Rhif EORI cofrestredig cwmni’r asiant
...
checkYourAnswersForAgents.applicant.jobTitle.label = Teitl swydd yr asiant
...
checkYourAnswersForAgents.declaration.bulletPoint.4 = rydych yn ymwybodol bod cael penderfyniad ar Ddyfarniad Prisio Ymlaen Llaw yn gallu cymryd hyd at 120 diwrnod o’r dyddiad y derbynnir eich cais
...
agentForTraderCheckYourAnswers.applicant.agent.heading = Ynglŷn â’r asiant

agentForTraderCheckYourAnswers.agent.eori.number.label = Rhif EORI cofrestredig eich cwmni
agentForTraderCheckYourAnswers.agent.name.label = enw busnes cofrestredig eich cwmni
agentForTraderCheckYourAnswers.agent.address.label = cyfeiriad busnes cofrestredig eich cwmni
agentForTraderCheckYourAnswers.agent.eori.number.hidden = Rhif EORI cofrestredig eich cwmni
agentForTraderCheckYourAnswers.agent.name.hidden = enw busnes cofrestredig eich cwmni
agentForTraderCheckYourAnswers.agent.address.hidden = cyfeiriad busnes cofrestredig eich cwmni

agentForTraderCheckYourAnswers.applicant.name.label = Enw llawn yr asiant
agentForTraderCheckYourAnswers.applicant.name.hidden = enw llawn yr Asiant
agentForTraderCheckYourAnswers.applicant.email.label = Cyfeiriad e-bost yr asiant
agentForTraderCheckYourAnswers.applicant.email.hidden = cyfeiriad e-bost yr Asiant
...
agentForTraderCheckYourAnswers.goods.heading = Ynglŷn â’r nwyddau
agentForTraderCheckYourAnswers.declaration.heading = Eich datganiad
agentForTraderCheckYourAnswers.declaration.paragraph1 = Drwy wneud cais am Ddyfarniad Prisio Ymlaen Llaw, rydych yn cadarnhau’r canlynol:
agentForTraderCheckYourAnswers.declaration.bulletPoint.1 = rydych wedi dewis y dull mwyaf perthnasol i brisio nwyddau’r masnachwr
agentForTraderCheckYourAnswers.declaration.bulletPoint.2 = mae’r wybodaeth a ddarparwyd gennych yn gywir ac yn gyflawn hyd eithaf eich gwybodaeth
agentForTraderCheckYourAnswers.declaration.bulletPoint.3 = rydych wedi darparu llythyr o awdurdod wedi’i lofnodi yn cadarnhau y gallwch weithredu ar ran y masnachwr
agentForTraderCheckYourAnswers.declaration.bulletPoint.4 = rydych yn ymwybodol y gall CThEF gysylltu â’r masnachwr i gadarnhau bod gennych yr hawl i wneud y cais hwn
agentForTraderCheckYourAnswers.declaration.bulletPoint.5 = mae eich cais yn seiliedig ar fwriad i fewnforio nwyddau i Brydain Fawr
agentForTraderCheckYourAnswers.declaration.bulletPoint.6 = rydych yn ymwybodol bod cael penderfyniad ar Ddyfarniad Prisio Ymlaen Llaw yn gallu cymryd hyd at 120 diwrnod o’r dyddiad y derbynnir eich cais
agentForTraderCheckYourAnswers.declaration.bulletPoint.7 = ni fydd angen i chi wneud cais am Ddyfarniad Prisio Ymlaen Llaw bob tro y byddwch yn mewnforio’r nwyddau hyn drwy’r un dull prisio, gan fod y dyfarniad yn gyfreithiol rwymol am dair blynedd o’r dyddiad cyhoeddi
agentForTraderCheckYourAnswers.agreement.subheading = Rydych yn cytuno y gall CThEF wneud y canlynol:
agentForTraderCheckYourAnswers.agreement.bulletPoint.1 = anghytuno â’r dull prisio yr ydych wedi’i ddewis
agentForTraderCheckYourAnswers.agreement.bulletPoint.2 = storio’r wybodaeth a ddarparwyd gennych (neu y gallech ei darparu) ar ôl i chi anfon eich cais
...
unauthorised.para.reason = Ni allwch gael mynediad at y gwasanaeth hwn oherwydd nad oes gennych chi ymrestriad dilys.
unauthorised.para.bta = I gofrestru ar gyfer y gwasanaeth hwn, bydd angen y canlynol arnoch:
unauthorised.list.1 = Dynodydd Defnyddiwr (ID) a chyfrinair ar gyfer Porth y Llywodraeth – os nad oes gennych y rhain, gallwch eu creu wrth wneud cais
unauthorised.list.2 = rhif EORI sy’n dechrau gyda GB
...
applicationComplete.paragraph.3 = Ein nod yw adolygu’ch cais cyn pen 30 diwrnod ar ôl i chi ei gyflwyno. Mae cael penderfyniad ar Ddyfarniad Prisio Ymlaen Llaw yn gallu cymryd 90 diwrnod arall.
applicationComplete.paragraph.4 = Gweler {0} os ydych yn bwriadu mewnforio nwyddau heb wneud cais am ddyfamiad uwch.
applicationComplete.paragraph.4.link = arweiniad cam wrth gam ar GOV.UK (yn agor tab newydd)
applicationComplete.button.continue = Ewch i’ch ceisiadau
applicationComplete.ruling.subheading = Sut i ddefnyddio’r dyfamiad
applicationComplete.ruling.paragraph.1 = Pan fyddwch yn cael dyfamiad, mae’n rhiad i chi wneud y canlynol:
applicationComplete.ruling.paragraph.2 = Bydd y cais am ddyfarniad a gyflwynoch yn cael ei storio yn y gwasanaeth hwn am 12 mis. Cadwch gopi o’r cais ar gyfer eich cofnodion.
applicationComplete.ruling.bulletPoint.1 = datgan eich cyfeimod Dyfamiadau Prisio Uwch yn eich {0}
applicationComplete.link.customsDeclaration = Datganiad Tollau (yn agor tab newydd)
...
applicationComplete.questions.para.1 = Cysylltwch â’r tîm Dyfarniadau Prisio Uwch drwy e-bostio {0} os oes gennych unrhyw gwestiynau ynghylch eich cais.
...
applicationComplete.appeal.paragraph.1 = Os nad ydych yn cytuno â’r penderfyniad, gallwch wneud cais am adolygiad drwy e-bostio’r tîm Dyfarniadau Prisio Uwch gan ddefnyddio’r cyfeiriad canlynol: {0}.
...
applicationComplete.appeal.paragraph.3.link = adolygiad ac apeliadau (yn agor tab newydd)
...
whatIsYourRoleAsImporter.warning = Ni ddylech newid eich dewis unwaith i chi ddechrau’r cais hwn. Bydd angen i chi greu cais newydd os ydych am newid eich rôl yn nes ymlaen.
...
whatIsYourRoleAsImporter.agentOnBehalfOfTrader.hint = Mae’n mewnforio nwyddau i’r DU ar ran masnachwr unigol.

businessContactDetails.title = Eich manylion cyswllt
businessContactDetails.heading = Eich manylion cyswllt
businessContactDetails.caption = Ynglŷn â’r ymgeisydd
businessContactDetails.paragraph.agentOrg = Byddwn ond yn defnyddio manylion cyswllt eich sefydliad os oes angen i ni gysylltu â chi ynghylch y cais rydych yn ei gyflwyno.
businessContactDetails.paragraph.agentTrader = Dim ond os bydd angen i ni gysylltu â chi ynghylch y cais rydych yn ei gyflwyno y byddwn yn defnyddio’r manylion hyn.
...
businessContactDetails.jobTitle.label = Teitl eich swydd
businessContactDetails.simpleChars.error.format = Mae’n rhaid i hyn gynnwys llythrennau, bylchau a chysylltnodau yn unig
...
businessContactDetails.email.error.format = Nodwch gyfeiriad e-bost yn y fformat cywir, megis enw@enghraifft.com
businessContactDetails.telephoneNumber.error.required = Nodwch eich rhif ffôn
businessContactDetails.telephoneNumber.error.format = Nodwch rif ffôn, megis 01632 960 001, 07700 900 982 neu +44 808 157 0192
businessContactDetails.checkYourAnswersLabel = businessContactDetails
businessContactDetails.change.hidden = manylion cyswllt yr ymgeisydd ei hun
businessContactDetails.name.change.hidden = eich enw cyswllt
businessContactDetails.email.change.hidden = eich cyfeiriad e-bost
businessContactDetails.telephoneNumber.change.hidden = eich rhif ffôn
businessContactDetails.companyName.label = Enw’r busnes cofrestredig
...
importingGoods.point.1.link = Dyfarniadau Tariffau Uwch (yn agor tab newydd)
...
importingGoods.point.2.link = Dyfarniadau Tarddiad Uwch (yn agor tab newydd)
importingGoods.point.3 = {0} am gyngor ynghylch sut i baratoi os ydych yn masnachu ac yn symud nwyddau i mewn ac allan o Ogledd Iwerddon
importingGoods.point.3.link = Masnachu a symud nwyddau i mewn ac allan o Ogledd Iwerddon (yn agor tab newydd)
importingGoods.point.4 = {0} ynghylch mewnforio nwyddau i’r DU
importingGoods.point.4.link = Canllaw cam wrth gam (yn agor tab newydd)
importingGoods.point.5 = {0} ynghylch mewnforio, allforio a thollau i fusnesau
importingGoods.point.5.link = Gwybodaeth gyffredinol (yn agor tab newydd)
importingGoods.point.6 = {0} - e-byst hysbysu gan CThEF, fideos a gweminarau ynghylch mewnforio ac allforio
importingGoods.point.6.link = Help a chefnogaeth (yn agor tab newydd)
...
accountHome.goodsDescription = Enw’r nwyddau
...
explainYourGoodsComparingToIdenticalGoods.heading = Esboniwch sut rydych yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf
explainYourGoodsComparingToIdenticalGoods.label = Esboniwch sut rydych yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf
explainYourGoodsComparingToIdenticalGoods.paragraph = Dylech chi ddefnyddio Dull 3: Gwerth trafodyn nwyddau tebyg os yw’r canlynol yn wir:
explainYourGoodsComparingToIdenticalGoods.bulletPoint.1 = nid ydych yn credu mai Dull 2 yw’r ffordd gywir o brisio’ch nwyddau
explainYourGoodsComparingToIdenticalGoods.bulletPoint.2 = nid oes gennych unrhyw wybodaeth bellach am y nwyddau unfath
...
explainYourGoodsComparingToIdenticalGoods.error.required = Nodwch esboniad o sut rydych yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf
explainYourGoodsComparingToIdenticalGoods.error.length = Caniateir uchafswm o 8168 o gymeriadau
explainYourGoodsComparingToIdenticalGoods.change.hidden = eich esboniad o sut rydych chi’n defnyddio nwyddau unfath cynhyrchydd arall at ddiben cymharu

willYouCompareGoodsToIdenticalGoods.title = A fyddwch yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf?
willYouCompareGoodsToIdenticalGoods.caption = Ynglŷn â’r nwyddau
willYouCompareGoodsToIdenticalGoods.heading = A fyddwch yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf?
willYouCompareGoodsToIdenticalGoods.no.text = Na – os byddwch yn dewis ‘na’ bydd angen i chi ddewis dull prisio gwahanol
willYouCompareGoodsToIdenticalGoods.checkYourAnswersLabel = A fyddwch yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf?
willYouCompareGoodsToIdenticalGoods.error.required = Dewiswch ‘Iawn’ os byddwch yn cymharu’ch nwyddau â nwyddau unfath a fewnforiwyd gan brynwr neu werthwr arall yn ystod y 90 diwrnod diwethaf
...
viewApplication.agent = Ynglŷn â’r asiant
viewApplication.trader = Ynglŷn â’r masnachwr
...
viewApplication.dateSubmitted = Dyddiad cyflwyno

viewApplication.aboutTheGoods.heading = Ynglŷn â’r nwyddau
viewApplication.yourRuling = Eich cais am Ddyfarniad Prisio Ymlaen Llaw
...
agentCompanyDetails.agentEori = Rhif EORI cofrestredig y sefydliad, sy’n dechrau gyda GB
...
agentCompanyDetails.error.agentEori.format = Nodwch rif EORI yn y fformat cywir

agentCompanyDetails.error.agentCompanyName.length = Mae’n rhaid i enw busnes cofrestredig eich cwmni fod yn 50 o gymeriadau neu lai
agentCompanyDetails.error.agentStreetAndNumber.length = Mae’n rhaid i linell 1 y cyfeiriad fod yn 70 o gymeriadau neu lai
agentCompanyDetails.error.agentCity.length = Mae’n rhaid i’r dref neu’r ddinas fod yn 35 o gymeriadau neu lai
agentCompanyDetails.error.agentCountry.length = Mae’n rhaid i’r wlad fod yn 50 o gymeriadau neu lai
agentCompanyDetails.error.agentPostalCode.length = Mae’n rhaid i’r cod post fod yn 9 o gymeriadau neu lai
...
checkYourAnswersForAgents.applicant.email.change.hidden = eich cyfeiriad e-bost
checkYourAnswersForAgents.applicant.phone.change.hidden = eich rhif ffôn
checkYourAnswersForAgents.applicant.jobTitle.change.hidden = Teitl eich swydd

deleteDraft.title = A ydych yn siŵr eich bod am ddileu’ch cais?
deleteDraft.heading = A ydych yn siŵr eich bod am ddileu’ch cais?
deleteDraft.error.required = Dewiswch ‘Iawn’ os ydych am ddileu’ch cais
...
traderDetails.public.h2.question.yes = Iawn, dyma fanylion y masnachwr rwyf yn gwneud cais ar ei ran
...
traderDetails.private.h3.proceed = A hoffech fynd yn eich blaen?
...
draftHasBeenSaved.para.1 =  Mae gennych tan {0} i gyflwyno’ch cais. Mae unrhyw atebion neu wybodaeth rydych wedi’u cyflwyno wedi’u cadw.
draftHasBeenSaved.para.2 =  Sylwer: bydd y cyfnod o 28 diwrnod yn ailddechrau bob tro yr ewch at eich drafft. Efallai y bydd angen i chi ailuwchlwytho unrhyw ddogfennau ategol.
draftHasBeenSaved.para.3 = I fwrw ymlaen â’ch cais, gallwch fynd ato drwy {0}.
draftHasBeenSaved.para.link.text = Eich ceisiadau

yourApplicationHasBeenCancelled.title = Ni allwch fwrw golwg dros y cais hwn
yourApplicationHasBeenCancelled.heading = Ni allwch fwrw golwg dros y cais hwn
yourApplicationHasBeenCancelled.paragraph.1 = Mae hyn o achos eich bod wedi canslo’ch cais am Ddyfarniad Prisio Ymlaen Llaw. Mae’r data y gwnaethoch eu cyflwyno’n gynt wedi cael eu dileu.
...
haveYouReceivedADecision.error.required = Dewiswch ‘Iawn’ os ydych wedi cael dyfarniad blaenorol yn seiliedig ar ddull tebyg
