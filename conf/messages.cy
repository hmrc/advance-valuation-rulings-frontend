...
applicationContactDetails.simpleChars.error.format = Must contain only letters, space and hyphens
...
businessContactDetails.paragraph.agentOrg = We will only use your organisation’s contact details if we need to get in touch about the application you are submitting.
businessContactDetails.paragraph.agentTrader = We will only use these details if we need to contact you about the application you are submitting.
...
businessContactDetails.simpleChars.error.format = Must contain only letters, space and hyphens
