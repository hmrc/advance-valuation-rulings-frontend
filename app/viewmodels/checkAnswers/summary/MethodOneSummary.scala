...
case class MethodOneSummary(rows: SummaryList) extends AnyVal

object MethodOneSummary {
  def apply(userAnswers: UserAnswers)(implicit messages: Messages): MethodOneSummary = {
    ...
    MethodOneSummary(SummaryListViewModel(rows))
  }
}
